...
if (isset($_GET['update'])) {
	...
	$id = $_GET['update'];
	 $id;
	$result=mysqli_query($conn, "select d.DoctorId,d.DoctorName,d.Qualification,d.Experience,df.PhoneNo from doctors as d join doctorinfo as df on d.DoctorId=df.DoctorId");
